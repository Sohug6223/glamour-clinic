<template>
    <header class="relative overflow-hidden bg-linear-to-r from-pink-100 to-purple-100" id="home">
        <article class="max-w-7xl mx-auto px-4 sm:px-8 py-16 md:py-28 flex flex-col-reverse lg:flex-row items-center gap-10 lg:gap-20">
            ...
            Experience world-class aesthetic treatments with personalized care. 
            From advanced skincare to non-surgical enhancements, 
            we help you glow with confidence — naturally and beautifully.

                    </p>
                </hgroup> 
                <!-- CTA Button -->
                 <nav data-aos="fade-up" data-aos-delay="600" class="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 mb-12">
                    <a href="#appoinment" class="bg-pink-600 hover:bg-pink-700 text-white text-center px-8 py-3 rounded-full transition-shadow-lg">
                        Book a Consultation
                    </a>
                 ...
                 <!-- Stats Section -->
                  <aside data-aos="fade-up" data-aos-delay="800" class="py-4">
                    <ul class="flex flex-warp justify-center lg:justify-start gap-x-6 gap-y-4 text-center">
